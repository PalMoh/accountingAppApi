...
if (isset($_POST['idcus'])    &&
    ...
    $result = mysqli_query($db->_connect(),"INSERT INTO req_in(idcus,dater,dtcus,csspr,cssdc,activ,notes) VALUES('$idcus','$dater','$dtcus','$csspr','$cssdc','$activ','$notes')");
    ...
    if ($result) {
        ...
        $response["success"] = 1;
        $response["message"] = "Sales bill successfully created.";
